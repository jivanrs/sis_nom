...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2014 a las 00:43:59
...
CREATE TABLE IF NOT EXISTS `empadministradora` (
  `idEmpAdminstradora` int(11) NOT NULL AUTO_INCREMENT,
  `EmpAdministradora` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  PRIMARY KEY (`idEmpAdminstradora`)
...
INSERT INTO `empadministradora` (`idEmpAdminstradora`, `EmpAdministradora`) VALUES
(1, 'Opcion 1'),
(2, 'Opcion 2'),
(3, 'Opcion 3');
...
INSERT INTO `recibos` (`idRecibos`, `FechaDeRecibo`, `rec_idPeriodo_FK`, `rec_idEmpleado_FK`, `PorPagar`, `Monto`, `TipoDeRecibo`, `ConceptoBono`) VALUES
(3, '2014-05-01', 1, 1, 5000, 5000, 0, NULL),
(4, '2014-05-30', 2, 1, 5000, 5000, 0, NULL),
(5, '2014-05-01', 1, 2, 20000, 20000, 0, NULL),
(6, '2014-05-30', 2, 2, 20000, 20000, 0, NULL);
...
ALTER TABLE `empleado`
  ADD CONSTRAINT `	emp_idEmpAdministradora_FK` FOREIGN KEY (`emp_idEmpAdministradora_FK`) REFERENCES `empadministradora` (`idEmpAdminstradora`) ON DELETE NO ACTION ON UPDATE NO ACTION,
