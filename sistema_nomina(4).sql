...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2014 a las 23:41:20
...
(1, 1, 1, 'Jurgen Feuchter Garcia', 'Holanda 2920 Col. del Carmen Monterrey Nuvo Leon', 'Practicante Desarrollador Web', 83337260, 2147483647, 15, 'jfeuchter@gmail.com', 'Banorte', '2345134513', '23513412351234', 10000, 1, 1),
...
INSERT INTO `pagos` (`idPagos`, `Pago`, `FechaDePago`, `pag_idEmpleado_FK`, `PagoEspecial`, `pag_idRecibos_FK`) VALUES
(1, 5000, '2014-05-01', 1, 0, 3),
(3, 1000, '2014-06-06', 1, 0, 4),
(7, 10000, '2014-06-06', 2, 0, 5),
(8, 20000, '2014-06-06', 2, 0, 6),
(9, 1000, '2014-06-06', 1, 0, 4),
(10, 3000, '2014-06-06', 1, 0, 4);
...
INSERT INTO `recibos` (`idRecibos`, `FechaDeRecibo`, `rec_idPeriodo_FK`, `rec_idEmpleado_FK`, `PorPagar`, `Monto`) VALUES
(3, '2014-05-01', 1, 1, 0, 5000),
(4, '2014-05-30', 2, 1, 0, 5000),
(5, '2014-05-01', 1, 2, 10000, 20000),
(6, '2014-05-30', 2, 2, 0, 20000);
